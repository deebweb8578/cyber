...
\x1b[1;96m╱╱╰━╯╱╱╱╱╱╱╱╱┃┃╭╯╰╮
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  Team : Cyber 71 Bangladesh 
\x1b[1;94m➣  CEO     : 💓Mohammad Touhidur Rahman Asif💕
\x1b[1;94m➣  Developed By   : Zihad Hossain (Rafi) 
\x1b[1;94m➣  Support Team   : Zihad Hossain Supported Cyber71 Bangladesh  
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(1)
            ...
            os.system('xdg-open https://www.facebook.com/groups/744268365744547')
    else:
        print "\033[1;97mACCESS DENIED"
...
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;97m👉 : \033[1;97mCyber 71 King Of Facebook' ) 
